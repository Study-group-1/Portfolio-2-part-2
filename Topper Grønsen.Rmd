...
#make data frame containing rmse for test, train, difference between the two, mean rmse of test and train respectively, difference between means and standard deviation of train and test
...
#make subset containing only Bernie's data

bernie <- subset(clean,  SUBJ == '2')

#get means of child MLU of Bernie and TD children respectively
...
#predict Bernie's data based on model
